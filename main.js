...
<button data-text="Awesome" class="button2 dark:hidden block">
  ...
  <span class="hover-text2" aria-hidden="true">&nbsp;Luiz&nbsp;&nbsp;Felipe&nbsp;</span>
    ...
    <section id="Experience" class="mt-20 mb-20 pt-8"><!-- added  py-10 for having the having section look better-->
      <div id="Experience">
        ...
        <div id="cards" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 px-4 sm:px-10 lg:px-20">
          <div id="block" class="mt-8 shadow-md dark:bg-zinc-900 bg-zinc-100 rounded-xl border-2 border-solid border-zinc-400 dark:border-zinc-700 hover:border-zinc-600 dark:hover:border-white  transform hover:scale-103 transition-transform">
            <img class="p-4 rounded-3xl" src="/Visteon.png" alt="Recipe Finder">
            ...
            <p class="dark:text-gray-100 font-semibold text-md tracking-tight p-2 mx-5"">
              There, my function was as a full stack developer. In this period, I worked with some frameworks and languages, these informations are in the skil content. 
            </p>
      ...
      <div id="projects">
        ...
        <div id="cards" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 px-4 sm:px-10 lg:px-20">
          <div id="block" class="mt-8 shadow-md dark:bg-zinc-900 bg-zinc-100 rounded-xl border-2 border-solid border-zinc-400 dark:border-zinc-700 hover:border-zinc-600 dark:hover:border-white  transform hover:scale-103 transition-transform">
            ...
            <div class="flex mt-4 mx-5 mb-5">
              <a href="https://github.com/LuizFelipeDias/Recipe-finder" class="bg-gray-900  items-center hover:scale-110 transition-transform transform dark:bg-gray-100 text-white dark:text-black flex gap-2 p-3 rounded-md font-medium ml-5">Github
